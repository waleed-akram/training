...
const Page = () => {
    ...
    const fetchGames = async () => {
      try {
        const result = await axios.request({
          ...
          headers: {
            "x-rapidapi-key":
              "ed53ff62ebmshd3703c3e6161c39p157812jsn6195af2cdf1d",
  ...
  return (
    <>
      {" "}
      <h1>Welcome to Game Hub</h1> <h4> Discover the latest games </h4>
      <p>Find your next favorite game from our extensive collection.</p>{" "}
